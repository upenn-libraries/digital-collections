...
We are working to support development in a new environment orchestrated by Taskfile. If there is a need to we will revive our original local Ruby and docker environment, but for now we are going to focus our efforts on this environment.
...
#### Interacting with Services in a browser
- Rails Application
